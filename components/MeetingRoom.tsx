...
const MeetingRoom = () => {
    ...
    return (
        <section className="relative h-screen w-full overflow-hidden pt-4 text-white">
            <div className="reltive flex-center size-full">
            ...
            <div className="fixed bottom-0 flex-center gap-5 w-full flex-col md:flex-row">
                <CallControls onLeave={() => router.push("/")}/>
                <div className="flex-center pb-4 md:pb-0 -mt-4 md:mt-0">
                    <div className="pr-4">
                        <DropdownMenu>
